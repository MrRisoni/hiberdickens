...
public class TimetableSrvc {
    ...
    {
        TimeTableRepository ttblRepo = new TimeTableRepository();
        ttblRepo.setEntityManager(entityManager);
        List<TimetableDTO> rawTimetable = ttblRepo.getTimetable();
